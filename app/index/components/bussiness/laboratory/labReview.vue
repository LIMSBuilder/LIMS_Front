                                                                        ...
                                                                        <template v-for="(dysodia,index) in item.items">
                                                                            <tr>
                                                                                ...
                                                                                <td class="text-center">
                                                                                    ...
                                                                                    <template v-if="dysodia.flag2==1">一审通过</template>
                                                                                </td>
                                                                            </tr>
                                                                        </template>
                                                                        </tbody>
                                                                        ...
                                                                        <template v-for="(air,index) in item.items">
                                                                            <tr>
                                                                                ...
                                                                                <td class="text-center">
                                                                                    ...
                                                                                    <template v-if="air.flag2==1">一审通过</template>
                                                                                </td>
                                                                            </tr>
                                                                        </template>
                                                                        </tbody>
                                                                        ...
                                                                        <template v-for="(water,index) in item.items">
                                                                            <tr>
                                                                                ...
                                                                                <td class="text-center">
                                                                                    ...
                                                                                    <template v-if="water.flag2==1">一审通过</template>
                                                                                </td>
                                                                            </tr>
                                                                        </template>
                                                                        </tbody>
                                                                        ...
                                                                        <template v-for="(solid,index) in item.items">
                                                                            <tr>
                                                                                ...
                                                                                <td class="text-center">
                                                                                    ...
                                                                                    <template v-if="solid.flag2==1">一审通过</template>
                                                                                </td>
                                                                            </tr>
                                                                        </template>
                                                                        </tbody>
                                                                        ...
                                                                        <template v-for="(soil,index) in item.items">
                                                                            <tr>
                                                                                ...
                                                                                <td class="text-center">
                                                                                    ...
                                                                                    <template v-if="soil.flag2==1">一审通过</template>
                                                                                </td>
                                                                            </tr>
                                                                        </template>
                                                                        </tbody>
