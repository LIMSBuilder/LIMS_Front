...
// app.use('/api', proxy({target: 'http://192.168.0.35:8080', changeOrigin: true}));
// app.use('/upload', proxy({target: 'http://192.168.0.35:8080', changeOrigin: true}));
// app.use('/pushlet.srv', proxy({target: 'http://192.168.0.35:8080', changeOrigin: true}));
