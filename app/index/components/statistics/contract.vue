    ...
    <div>
        ...
        <div class="row">
            <div class="col-md-12">
                <!-- BEGIN TODO SIDEBAR -->
                <div class="todo-ui">
                    <div style="width: 310px;" class="todo-sidebar">
    ...
    module.exports = {
        ...
        mounted(){
            ...
            $('#defaultrange').daterangepicker({
                    ...
                    ranges: {
                        '今日完成': [moment(), moment()],
                        '过去七天完成': [moment().add('days', -6), moment()],
                        '过去一月完成': [moment().add('days', 29), moment()],
                        '本月完成': [moment().startOf('month'), moment()]
                    },
                    minDate: '01/01/2012',
                    maxDate: '12/31/2018'
                },
