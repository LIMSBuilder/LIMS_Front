                    ...
                    <div class="inbox-sidebar">
                        ...
                        <ul class="inbox-nav">
                            ...
                            <router-link :to="{ path: '/mail/inbox'}" tag="li" active-class="active">
                                <a href="javascript:;" data-type="收件箱" data-title="收件箱"> 收件箱
                                    <span class="badge badge-success" v-if="count!=0">{{count}}</span>
                                </a>
                            </router-link>
                            ...
                            <router-link :to="{ path: '/mail/outbox' }" tag="li" active-class="active">
                        ...
                        <ul class="inbox-contacts">
                            ...
                            <template v-for="item in related">
                                <li>
                                    <a href="javascript:;" @click="relatedLink(item.id)">
                                        <img class="contact-pic" src="../../../global/img/default_user_avatar.png"
                                             v-if="!item.portrait">
                                        <img class="contact-pic" :src="item.portrait" v-else>
...
<script>
    module.exports = {
        ...
        methods: {
            ...
            fetchCount(){
                var me = this;
                me.$http.get("/api/mail/initMail").then(response => {
                    var data = response.data;
                    codeState(data.code, {
                        200: function () {
                            me.count = data.count;
                            me.related = data.related;
                        }
                    })
                }, response => {
                    serverErrorInfo();
            ...
            relatedLink(id){
                router.push("/mail/compose?receiver=" + id);
            }
        }
    };
</script>