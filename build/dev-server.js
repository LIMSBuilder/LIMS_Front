...
app.use('/api', proxy({target: 'http://192.168.0.38:8080', changeOrigin: true}));
app.use('/upload', proxy({target: 'http://192.168.0.38:8080', changeOrigin: true}));
app.use('/pushlet.srv', proxy({target: 'http://192.168.0.38:8080', changeOrigin: true}));
// 监听 8888端口，开启服务器
